...
describe('Get Team', () => {
    ...
    it('should throw error on incorrect id field', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/123/teams/${uuid.v4()}`, {
                body: {},
                json: true,
                headers: {
    ...
    it('should throw error if the document not exists', async () => {
        try {
            await request.get(`${helpers.API_URL}/api/v1/merchants/${uuid.v4()}/teams/${uuid.v4()}`, {
                body: {
                },
                json: true,
                headers: {
    ...
    it('should get document when all validation passes', async () => {

        const result = await request.get(`${helpers.API_URL}/api/v1/merchants/${sampleTeams.merchantID}/teams/${sampleTeams._id}`, {
            body: {
                'name': 'test'
            },
            json: true,
